export default {
  ...
  examples: [
    { id: 'vd-bb-dem-tan-suat', title: 'Đếm số lần xuất hiện của từng từ trong một đoạn văn', official: false },
    { id: 'vd-bb-va-cham-va-resize', title: 'Xem bảng băm va chạm và tự nở ra như thế nào', official: false },
  ],
  quiz: [
    {
  ...
  project: {
    ...
    must: [
      ...
      'Kết quả 20 từ đầu khớp với kết quả của một bản viết bằng std::unordered_map dùng làm mốc đối chiếu.',
      'Có ít nhất ba ca kiểm thử tự động: bảng giữ đúng dữ liệu sau khi nở ra, xoá khoá rồi tra lại thì không còn, hai khoá cố tình va chạm vẫn lấy đúng giá trị của từng khoá.',
    ],
    traps: [
